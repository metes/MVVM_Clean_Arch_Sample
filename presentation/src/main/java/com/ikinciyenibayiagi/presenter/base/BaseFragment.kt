package com.ikinciyenibayiagi.presenter.base
...
import com.ikinciyenibayiagi.presenter.utils.CommonUtils
import com.ikinciyenibayiagi.presenter.utils.ContextExtentions.hideKeyboard
...
abstract class BaseFragment<BindingType : ViewBinding, out ViewModelType : BaseViewModel>
    ...
    private fun subscribeErrors() {
        viewModel.errorMessageSLE.observe(viewLifecycleOwner) { errorMessage ->
            when {
                errorMessage.isNullOrBlank() -> getString(R.string.error_message_main)
                else -> errorMessage.showAsErrorDialog()
            }
        }
    }
